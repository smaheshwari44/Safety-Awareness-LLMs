...
def prepare_datasets(activations, labels, global_labels, layer):
    ...
    for domain in np.unique(global_labels):
        ...
        domain_x_tensor = torch.tensor(domain_x, dtype=torch.float32)
        domain_y_tensor = torch.tensor(domain_y, dtype=torch.float32)
        total_count = len(domain_y_tensor)
        train_count = int(0.7 * total_count)
        val_count = int(0.1 * total_count)
        test_count = total_count - train_count - val_count
        full_dataset = TensorDataset(domain_x_tensor, domain_y_tensor)
        train_dataset, remaining_dataset = random_split(full_dataset, [train_count, total_count - train_count])
        val_dataset, test_dataset = random_split(remaining_dataset, [val_count, test_count])
...
#layers = [1, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40]
# pickle_file = ["LLM_HARMS_LLAMA2_7B_EMBEDDINGS.pkl","LLM_HARMS_LLAMA2_13B_EMBEDDINGS.pkl","LLM_HARMS_LLAMA3_8B_EMBEDDINGS.pkl","LLM_HARMS_MISTRAL_7B_EMBEDDINGS.pkl","LLM_HARMS_MISTRAL_8x7B_EMBEDDINGS.pkl"]
# layers = [[1, 4, 8, 12, 16, 20, 24, 28, 32],[1, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40],[1, 4, 8, 12, 16, 20, 24, 28, 32],[1, 4, 8, 12, 16, 20, 24, 28, 32],[1, 4, 8, 12, 16, 20, 24, 28, 32]]
# save_paths = ["logistic_regression_results_llama2_7b.csv","logistic_regression_results_llama2_13b.csv","logistic_regression_results_llama3_8b.csv","logistic_regression_results_mistral_7b.csv","logistic_regression_results_mistral_8x7b.csv"]
# pickle_file = ["LLM_HARMS_LLAMA3_70B_EMBEDDINGS.pkl"]
# layers = [[1, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80]]
# save_paths = ["logistic_regression_results_llama3_70b.csv"]
...
save_paths = [
    "logistic_regression_results_llama2_7b.csv",
    "logistic_regression_results_llama2_7b_chat.csv",
    "logistic_regression_results_llama2_13b.csv",
    "logistic_regression_results_llama2_70b.csv",
    "logistic_regression_results_llama2_70b_chat.csv",
    "logistic_regression_results_llama3_8b.csv",
    "logistic_regression_results_llama3_8b_instruct.csv",
    "logistic_regression_results_llama3_70b.csv",
    "logistic_regression_results_llama3_70b_instruct.csv",
    "logistic_regression_results_mistral_7b.csv",
    "logistic_regression_results_mistral_8x7b.csv",
    "logistic_regression_results_bert.csv",
    "logistic_regression_results_roberta.csv",
    ]
